...
hA.t <- c("Preparing_Breakfast", "Preparing_Dinner", "Preparing_Lunch", 
             "Washing_Dishes", "Laundry", "Cleaning")           
hB.t <- c("Preparing Breakfast", "Preparing Dinner", "Preparing Lunch", 
...
hA.r <- c("Going_Out", "Having_Breakfast", "Having_Dinner", "Having_Lunch", 
          "Watching_TV", "Napping", "Listening_to_Music", "Having_Guest")           
hB.r <- c("Going Out", "Having Breakfast", "Having Dinner", "Having Lunch", 
          "Watching TV", "Napping", "Having Guest")
